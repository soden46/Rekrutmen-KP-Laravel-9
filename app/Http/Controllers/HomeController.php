...
class HomeController extends Controller
{
    ...
    public function recruitment()
    {
        ...
        $provinsi = Caffe::select('provinsi', Caffe::raw('count(*) as total1'))
            ->groupBy('provinsi')
            ->get();
        $jumlahc = Caffe::select('group_caffe', Caffe::raw("COUNT(*) as count"))
            ->groupBy('group_caffe')
            ->get();
        ...
        return view('home.recruitment', compact('provinsi', 'caffe', 'kafe', 'jumlahp', 'jumlahp2', 'jumlahp3', 'jumlahp4', 'jumlahp5', 'jumlahp6', 'jumlahp7', 'jumlahp8', 'jumlahc', 'jumlahc2', 'jumlahc3', 'jumlahc4', 'jumlahc5', 'jumlahc6', 'jumlahc7', 'jumlahc8'));
    }
